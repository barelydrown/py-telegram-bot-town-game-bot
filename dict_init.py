...
start_message = ('Привет, *{}*! Сыграем? Для начала выбери режим игры. \n\n'
                 '_Пиши /rules, чтобы ознакомиться с правилами. \n'
                 'Пиши /info, чтобы узнать подробнее о работе бота. \n'
                 'Пиши /progress, чтобы посмотреть ход игры._')

help_message = ('_Пиши /rules, чтобы ознакомиться с правилами. \n'
                'Пиши /info, чтобы узнать подробнее о работе бота. \n'
                'Пиши /progress, чтобы посмотреть ход игры._')
